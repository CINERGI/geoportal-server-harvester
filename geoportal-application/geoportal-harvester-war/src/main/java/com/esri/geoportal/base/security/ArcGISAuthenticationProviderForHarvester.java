 ...
 */
@Component
public class ArcGISAuthenticationProviderForHarvester implements AuthenticationProvider {
  
  private static final Logger LOGGER = LoggerFactory.getLogger(ArcGISAuthenticationProviderForHarvester.class);

 ...
 */
public class LdapUserContextMapperForHarvester extends LdapUserDetailsMapper {
  
  private static final Logger LOGGER = LoggerFactory.getLogger(LdapUserContextMapperForHarvester.class);
  ...
  /** Constructor. */
  public LdapUserContextMapperForHarvester() {
    super();
  }
